...
class CIFAR10(BaseDataModule):
	...
	def _setup(self):
		...
		train_data = torchvision.datasets.CIFAR10(root=self.root, train=True, download=True)
		test_data = torchvision.datasets.CIFAR10(root=self.root, train=False, download=True)
